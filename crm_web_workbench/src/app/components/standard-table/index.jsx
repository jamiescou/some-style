...
/* 标准对象的table组件 其他地方的table和标准对象的table需求一样可以直接引入 */
...
import Bar from 'container/standard-object/listview/bar';
...
import TrComponent from './tr-components';
...
class DataTable extends Component {
    ...
    _renderRow(_fields, dataVal, id, dataIndex) {
        let {info, config, schema, data, hashList, objName } = this.props;
        let onChecked = this.props.handleChecked;
        return (
            <TrComponent
                key={id + dataIndex}
                id={id}
                ...
                deleteHashData={this.props.deleteHashData}
                fields={_fields}
