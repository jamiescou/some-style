    ...
    renderOptionalButtons(props = this.props) {
        ...
        let optionalButtons = (config = configs) => {
            ...
            return result.length > 0 ? result : [
                objName === 'Leads' ? <CreateModal
                    fromPage="detail" ref="createModal" key="create" trigger={<Button className="mcds-button__item">新建对象</Button>} className="mcds-button__item"
                    objName={layoutObjName || objName} /> : null
            ];
        };
